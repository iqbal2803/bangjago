        ...
        <div class="card-body">
                <table id="example1" class="table table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{ format_price($bank->biaya_transfer)}}</td>
                    <td>{{ format_price($bank->biaya_tarik_tunai)}}</td>
                    <td>
                      ...
                      <div class="dropdown-menu" role="menu">
                        ...
                        <a class="dropdown-item" data-toggle="modal" data-target="#modal-sm{{ $bank->id}}">Hapus</a>
                      </div>
                    </td>
                  </tr>

                  <div class="modal fade" id="modal-sm{{ $bank->id}}">
                    <div class="modal-dialog modal-sm{{ $bank->id}}">
                      <div class="modal-content">
                        <div class="modal-body">
                          <p>Apakah anda akan menghapus data bank?</p>
                        </div>
                        <div class="modal-footer justify-content-between">
                          <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                          <a href="{{url('bank/hapus_bank/'.$bank->id)}}"><button type="button" class="btn btn-primary" >Konfirmasi</button></a>
                        </div>
                      </div>
                      <!-- /.modal-content -->
                    </div>
