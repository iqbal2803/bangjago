                ...
                <form role="form">
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2">
                        <input type="text" class="form-control" name="biaya_transfer" id="biaya_transfer" placeholder="Biaya Transfer" value="{{$bank->biaya_transfer}}" required="">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-1">
                      ...
                      <div class="col-sm-2">
                        <input type="text" class="form-control" name="biaya_tarik_tunai" id="biaya_tarik_tunai" placeholder="Biaya Tarik Tunai" value="{{$bank->biaya_tarik_tunai}}" required="">
                      </div>
                    </div>
