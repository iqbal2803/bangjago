  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Daftar Rekening Pelanggan</h1>
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Daftar Rekening Pelanggan</h3>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" href="{{url('daftar_pelanggan/edit_daftar_bank/'.$data->id)}}">Edit</a>
                    ...
                    <div class="modal-dialog modal-sm{{ $data->id}}">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-between">
                          ...
                          <a href="{{url('daftar_pelanggan/hapus_daftar_bank/'.$data->id)}}"><button type="button" class="btn btn-primary" >Konfirmasi</button></a>
                        </div>
                      </div>
                      <!-- /.modal-content -->
                    </div>
