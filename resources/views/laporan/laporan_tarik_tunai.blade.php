    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header d-flex">
          <h3 class="card-title" style="padding-top: 15px;">Laporan Transaksi Tarik Tunai</h3>
  ...
  <script type="text/javascript">
    ...
    //     } );
        ...
        $("#btn_cetak").on('click',function(){
            ...
            window.location.href = "{{ url('laporan/cetak_laporan_transaksi_tarik_tunai/filter_bank/filter_tgl/filter_search') }}".replace('filter_bank',filter_bank).replace('filter_tgl',filter_tgl).replace('filter_search',filter_search);
          }
        });
    } );
