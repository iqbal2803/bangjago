    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header d-flex">
          <h3 class="card-title" style="padding-top: 15px;">Riwayat Transaksi Tagihan</h3>
                    ...
                    <td>{{ $data->status}}</td>
                     ...
                     <td>
                      ...
                      <div class="dropdown-menu" role="menu">
                        ...
                        <a class="dropdown-item" href="{{url('transaksi/cetak_invoice_tagihan/'.$data->nomor_transaksi)}}">Cetak Invoice</a>
                      </div>
                      @else
                      <a href="{{url('transaksi/cetak_invoice_tagihan/'.$data->nomor_transaksi)}}"><button class="btn btn-info btn-flat">Cetak Invoice</button></a>
                      @endif
                    </td>
                    @endif
                  </tr>
                    ...
                    <div class="modal-dialog modal-sm{{ $data->nomor_transaksi}}">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-between">
                          ...
                          <a href="{{url('transaksi/update_status_tagihan/'.$data->nomor_transaksi)}}"><button type="button" class="btn btn-primary" >Konfirmasi</button></a>
                        </div>
                      </div>
                      <!-- /.modal-content -->
                    </div>
