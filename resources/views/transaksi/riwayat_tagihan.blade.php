                    ...
                    <td>{{ $data->status}}</td>
                     ...
                     <td>
                      ...
                      <div class="dropdown-menu" role="menu">
                        <a class="dropdown-item" href="{{url('transaksi/update_status_tagihan/'.$data->nomor_transaksi)}}">Ganti Status</a>
                        <a class="dropdown-item" href="{{url('transaksi/cetak_invoice_tagihan/'.$data->nomor_transaksi)}}">Cetak Invoice</a>
                      </div>
                      @else
                      <a href="{{url('transaksi.cetak_invoice_tagihan/'.$data->nomor_pesanan)}}"><button class="btn btn-info btn-flat">Cetak Invoice</button></a>
                      @endif
                    </td>
                    @endif
                  </tr>
