...
class TransaksiController extends Controller
{
    ...
    public function cetak_invoice_transfer($nomor_transaksi)
    {
        ...
        $pdf = PDF::setOptions([
                    ...
                    ])->loadView('transaksi.cabang_cetak_invoice_transfer',$data)->setPaper([20, 0, 164.409, 450]);
    ...
    public function cetak_invoice_tarik_tunai($nomor_transaksi)
    {
        ...
        $pdf = PDF::setOptions([
                        ...
                        'logOutputFile' => storage_path('logs/log.htm'),
                        'tempDir' => storage_path('logs/')
                    ])->loadView('transaksi.cabang_cetak_invoice_tarik_tunai',$data)->setPaper([20, 0, 164.409, 450]);
    ...
    public function cetak_invoice_tagihan($nomor_transaksi)
    {
        ...
        $pdf = PDF::setOptions([
                        ...
                        'logOutputFile' => storage_path('logs/log.htm'),
                        'tempDir' => storage_path('logs/')
                    ])->loadView('transaksi.cabang_cetak_invoice_tagihan',$data)->setPaper([20, 0, 164.409, 450]);
